...
export async function GET(request, { params }) {
  try {
    ...
    const { eventId } = await params
    logger.error('Failed to fetch demo day judges', { eventId: eventId, error: error.message })
    return NextResponse.json(
...
export async function POST(request, { params }) {
  try {
    ...
    const { eventId } = await params
    logger.error('Failed to assign demo day judge', { eventId: eventId, error: error.message })
    return NextResponse.json(
...
export async function DELETE(request, { params }) {
  try {
    ...
    const { eventId } = await params
    logger.error('Failed to remove demo day judge', { eventId: eventId, error: error.message })
    return NextResponse.json(
