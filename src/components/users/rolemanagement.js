...
export default function RoleManagement() {
  ...
  const handleCreateRole = async () => {
    ...
    console.log(roleForm.onboardingFields)
    ...
    <div className="min-h-screen bg-snow-100">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-charcoal-900">Role Management</h1>
            <p className="text-slate-gray-600 mt-2">
              Manage workspace roles, permissions, and onboarding requirements
            </p>
          </div>
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              ...
              <DialogContent className="w-full max-w-[95vw] sm:max-w-2xl lg:max-w-4xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Set up a new role with permissions and onboarding requirements
                  </DialogDescription>
                </DialogHeader>
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={e =>
                              setRoleForm(prev => ({ ...prev, color: e.target.value }))
                            }
                ...
                <DialogFooter className="flex-col sm:flex-row gap-2 sm:gap-0">
                  ...
                  <Button
                    ...
                    disabled={
                      isSaving || !roleForm.name.trim() || roleForm.permissions.length === 0
                    }
        ...
        {/* Filters */}
        <Card className="starboard-card mb-6">
